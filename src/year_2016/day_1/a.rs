...
pub fn solve() -> String {
    let mut file = File::open("inputs/2016/1/directions.txt").expect("inputs/2016/1/directions.txt not found");
    let mut contents = String::new();
    file.read_to_string(&mut contents).expect("Error reading inputs/2016/1/directions.txt");
    let mut pos = (0, 0);
